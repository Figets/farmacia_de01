package com.example.application.views.recetas;
...
@Uses(Icon.class)
public class RecetasView extends Div {
    ...
    public RecetasView(SamplePersonService SamplePersonService) {
        this.samplePersonService = SamplePersonService;
        setSizeFull();
        addClassNames("recetas-view");
